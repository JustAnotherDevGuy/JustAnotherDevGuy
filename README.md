...
# Hey, I'm JustAnotherDevGuy

**Backend-focused Full-Stack Developer & Linux Infrastructure Engineer from Germany**

Building resilient systems, automating everything, and running Kubernetes across borders.
...
I run a **multi-region Talos Linux Kubernetes cluster** for high availability, spread across two locations:

| Location | Setup | Platform |
|---|---|---|
...
- Architect and ship backend services that power web and mobile products
- Build performant APIs and data models with reliability in mind
- Ship modern frontends with Next.js when the project calls for it
- Design and maintain multi-region Kubernetes infrastructure
- Automate deployments, operations, and everything in between
